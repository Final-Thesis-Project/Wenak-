...
export class ConfirmPage extends Component {
  ...
  continue = e => {
    ...
    var distanceInMeters = this.getDistanceBetweenPoints(
      lat1,
      lang1,
      lat2,
      lang2
          ...
          <Dialog open="true" fullWidth="true" maxWidth="sm">
            ...
            <List>
              ...
              <ListItem>
                <ListItemText
                  primary="PickupLng"
                  secondary={location_start_lng}
                />
                <ListItemText
                  primary="PickupLat"
                  secondary={location_start_lat}
                />
              </ListItem>
              <ListItem>
                <ListItemText
                  primary="DropOffLng"
                  secondary={location_end_lng}
                />
                <ListItemText
                  primary="DropOffLat"
                  secondary={location_end_lat}
                />
              </ListItem>
              <ListItem>
                <ListItemText
                  primary="Receiver Name"
                  secondary={recieverName}
                />
              </ListItem>
              <ListItem>
                <ListItemText
                  primary="Receiver Phone"
                  secondary={recieverPhone}
                />
              </ListItem>
              <ListItem>
